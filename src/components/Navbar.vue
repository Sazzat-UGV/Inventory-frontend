        ...
        <div class="d-flex">
          ...
          <div class="navbar-brand-box">
            <a href="index.html" class="logo logo-dark">
              ...
              <span class="logo-lg">
                <img src="../assets/images/logo-sm.svg" alt="" height="26" />
                <span class="logo-txt">Vuesy</span>
              </span>
            </a>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="topnav-more">
                      <div class="dropdown">
                        ...
                        <div
                          class="dropdown-menu"
                          aria-labelledby="topnav-pricing"
                        >
                          <a
                      ...
                      <div class="dropdown">
                        ...
                        <div
                          class="dropdown-menu"
                          aria-labelledby="topnav-timeline"
                        >
                          <a
                    ...
                    <div class="flex-grow-1">
                      ...
                      <div class="text-muted">
                        <p class="mb-1 font-size-13">
                          ...
                          <span class="badgebg-success-subtle text-success"
                            >Review</span
                          >
                        </p>
                  ...
                  <div class="d-flex border-bottom align-items-start">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <div class="text-muted">
                        ...
                        <p class="mb-0 font-size-10 text-uppercase fw-bold">
                          <i class="mdi mdi-clock-outline"></i> 5 hours ago
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="d-flex border-bottom align-items-start">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <div class="text-muted">
                        ...
                        <p class="mb-0 font-size-10 text-uppercase fw-bold">
                          <i class="mdi mdi-clock-outline"></i> 3 days ago
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div class="dropdown d-inline-block">
            ...
            >
              ...
              <span class="ms-2 d-none d-xl-inline-block user-item-desc">
                <span class="user-name"
                  >Marie N. <i class="mdi mdi-chevron-down"></i
                ></span>
              </span>
            </button>
            <div class="dropdown-menu dropdown-menu-end pt-0">
              ...
              <a
                ...
                ><span class="badgebg-success-subtle text-success ms-auto"
                  >New</span
                ></a
              >
              ...
              >
                ...
                <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item page-head">
